...
\begin{document}
	...
	\begin{figure}[h!]
		...
		\caption[caption]{Valamely demenciával diagnosztizáltak számának emelkedése}
	...
	\section{Memóriakezelés az InterOp marshal segítségével}
	\label{memhandling}
	...
	\begin{figure}[h!]
		...
		\caption{Azonosítók átadása JSON-formátumon keresztül}
		\label{json_azonositok}
	\end{figure}
	\subsection{Konvertálás JSON-formátumra}
	Delphi-oldalon megírtuk a JSON-re konvertáló függvényt, hogyan fogjuk ezt C\#-ból elérni?
	\subsubsection{Megoldás:} A korábbi SLDLL-hez fűzzük őket, vagy tegyük egy új DLL-állományba őket, és ezeket is meg kell hirdetnünk a C\#-os futtatókörnyezet számára is. A választott megoldásom az új DLL-re esett, egy úgynevezett relayDLL-t írtam Delphiben, amelyen keresztül az SLDLL-függvényeket meg tudjuk hívni.
	
	Ennek legfőbb indoka az volt, ami eldöntötte, hogy érdemes a hívó (.NETben készült FormHelperDLL) és hívott (SLDLL) felek között egy köztes réteget elkészíteni, hogy Delphiben különböző globális változók kapnak értéket, amelyeket nem tudunk máshol definiálni, csakis Delphiben, tehát a hívás környezetét így tudjuk megteremteni, hogy az értékadások ténylegesen működjenek, ne fussunk \verb*|NullReferenceException|-hibákra.\\
	...
	az \verb*|SLDLL_Open| függvény egy handle-t vár
	...
	\begin{figure}[h!]
		\includegraphics[scale=0.65]{hibas_string_delphi}
	...
	Továbbá a Delphi DLL függvénye \verb*|PAnsiChar|-t ad vissza, de a marshal alapértelmezés szerint \verb*|PWideChar|-t vár, mivel a C\# oldalon nem alkalmaztuk a \\\verb*|[return:MarshalAs(UnmanagedType.LPStr)]| attribútumot a DLL-funkció deklarációjában.
	\begin{figure}[h!]
		\centering
