...
\begin{document}
	...
	\begin{verbatim}
		...
		nevlei, devusb: pchar;
		begin
		result := SLDLL_Open(wndhnd, UZESAJ, @nevlei, @devusb); //result: a visszatérési értéknek lefoglalt hivatkozási név Delphi-függvények esetében
		end;
	\end{verbatim}
	...
	\begin{verbatim}
		...
		begin
			showmessage(
				format('Dev485 is empty drb485 = %d dev485 = %p', 
				[drb485, @dev485]));
			outputStr := '[]';
			result := DEV485_EMPTY;
		exit;
		...
		//a végére tett vessző a valid
		JSON-formátumot elrontja, ezt kicserélem tömbvége-jelre
