...
\begin{document}
	...
	\begin{figure}[h!]
		\centering
		\hspace*{-0.5in}
		\includegraphics[scale=0.7]{marshalas}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[scale=0.3]{images/foto_lampa.jpg}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[scale=0.3]{images/foto_nyil.jpg}
		\caption{Nyíl eszköz}
		\label{fig:foto_nyil}
	\end{figure}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[scale=0.5]{images/foto_rj9.jpg}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[scale=0.5]{images/foto_usbab.jpg}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[scale=0.5]{images/foto_tapkabel.jpg}
	...
	A RelayDLL állomány elkészülését Dr. Király Roland tanár úr javasolta abból a célból, hogy az SLDLL hívható függvényeinek listáját bővítsük, valamint a paraméterezést, így a függvényhívások módját egyszerűsítsük.
	...
	\begin{verbatim}
		function create_json(device_ids:pinteger;length:integer):pchar; stdcall; external 'converter32.dll' //C-ből vettük ezt a függvényt, amelynek implementációja converter32.dll-ben van
	\end{verbatim}

	A függvény meghívása Delphiben 
	\begin{verbatim}
	...
	\centering
	\hspace*{-0.5in}
	\includegraphics[scale=0.75]{images/fuggvenyek_kezi.jpg}
	...
	\section{Létrehozott osztályok}
	\begin{enumerate}
		\item Device: absztrakt osztály, minden eszköz őse, ebben tárolom az eszközök azonosítóját
		\item LEDArrow
		\item LEDLight
		\item 
	\end{enumerate}
	\section{Létrehozott metódusok}
