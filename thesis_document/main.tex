...
\begin{document}
	...
	Ezenkívül nemcsak adatok, hanem szolgáltatások leírására egyaránt alkalmas a Proto-nyelv, ezért is érdemes az RPC ezen változatát használni, mivel nagyobb rugalmasságot biztosít, mint egy átlagos szerializált formátum.
	\begin{figure}[h]
		\centering
	...
	\end{itemize}
	%todo: ez alapján sajátot készíteni
	\begin{figure}[h!]
		\centering
		\includegraphics[scale=0.8]{grpc_calls}
		\caption{gRPC metódushívásainak típusai}
		\label{fig:grpc_calls}
	\end{figure}
	%TODO: magyarázat az ábrához
	Az alábbi ábrán látható, hogy a gRPC sokkal gyorsabb volt, mint az összes REST-hívás, a kísérlet győztese a \verb*|Client Streaming| volt, ami 15-ször gyorsabb, mint a leglassabb REST-módszer, és legalább 5-6-szor gyorsabb, mint egy átlagos REST JSON-hívásokkal. A másik két gRPC módszer hasonlóan teljesített, és közel egy ezredmásodperccel lassabb. 
	\cite{grpc_performance}
	\begin{figure}[h!]
		\centering
		\includegraphics[scale=0.3]{grpc_json}
