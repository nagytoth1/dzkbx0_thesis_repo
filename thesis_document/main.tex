...
\begin{document}
	...
	\begin{enumerate}
		\item Elnevezések: Mivel nagy projekteknél előfordulhat, hogy két, funkciójában eltérő osztálynak ugyanazt a nevet kellene adnunk, nem tehetnénk meg, mivel a fordítóprogram nem tudná eldönteni, hogy a két változat közül éppen melyiket kívánjuk érvényesíteni. Ezt a problémát orvosoljuk például a kódok modulokra való felosztásával.
		
		\item Egységbe zárás: A modulok lehetővé teszik a programozók számára, hogy egy funkcionalitás végrehajtási részleteit kapszulázzák és elrejtsék. Ez azt jelenti, hogy a modulok tiszta felületet biztosítanak a funkcionalitással való interakcióhoz, miközben a mögöttes kódot elrejtik és védik a véletlen változásoktól.
		
		\item Újrafelhasználhatóság: A kód modulokba történő kapszulázásával a programozók olyan kódot hozhatnak létre, amely több programban is felhasználható. Ez csökkenti a fejlesztési időt és erőfeszítéseket azáltal, hogy a programozók újra felhasználhatják a már megírt és tesztelt kódot.
		
		\item Karbantarthatóság: Ha a kódot modulokba szervezik, könnyebb karbantartani és frissíteni, mivel az egyik modulban anélkül lehet változtatásokat végrehajtani, hogy az befolyásolná az azt használó többi modult. Ez javítja a kód karbantarthatóságát és csökkenti a hibák bevezetésének valószínűségét.
		
		\item Moduláris felépítés: A modulok megkönnyítik a nagy programok kisebb, könnyebben kezelhető darabokra bontását. Ez megkönnyíti a kód megértését és a program különböző részein való egyidejű munkát.
		
		Összességében a modulok a modern programozás alapvető részét képezik, mivel hatékony mechanizmust biztosítanak a kód szervezéséhez, újrafelhasználásához és karbantartásához.
		Ezért a programozók a programokat önálló darabokra tervezik, amelyeket meg tudnak írni, majd elfelejtik a belső részek részleteit, és csak a külsőségekkel foglalkoznak, azzal, hogy mit csinál a darab. A modulok ennek egyik módja,
		\item Egy lefejlesztett DLL tekintetében szükség van egy olyan összefoglaló névre, amire a használathoz hivatkozni tudunk.
