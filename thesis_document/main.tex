...
\begin{document}
	...
	\begin{figure}[h!]
		...
		\label{fig:foto_nyil}
	\end{figure}
	% todo: fotó a hangszóróról - Levente
	...
	A metódus az SLDLL dev485-tömbjét C\# által is értelmezhető JSON formátumú szöveggé alakítja (szerializálja). Ehhez a relayDLL egy újabb, C nyelvű kódból lefordított \textit{converter32.dll} állományt hívja segítségül. Ezt szintén én készítettem el, viszont az abban használt JSON-keretrendszert Michael Grieco szoftverfejlesztőtől vettem át.\cite{mgrieco}
	%todo: erről a függvényről írni egy bekezdést- create_json_from_azonositok()
	Mivel a Delphi 7-hez nem találtam beépített JSON-kezelő függvényeket, ezért megírtam egy olyan függvényt, ami azt a JSON-formátumot készíti el, amire nekünk szükségünk van: 
	\begin{verbatim} 
		[{"azonos":16385}, {"azonos":32770}, {"azonos":49153}, ...]
	\end{verbatim}
	A C-nyelvű implementáció azonban hatékonyabban elvégzi ugyanezt a JSON-szerializációt, mint korábban a manuális, összefűzögetős módszerrel.
	...
	%todo: verbatimként iderakni az új Delphi-kódot
	...
	\subcaption{Forrás: \\táblázat: saját szerkesztés, \\adatok: SLDLL-állomány}
	...
	A rajzon látható módon kötöttük be az eszközöket, és háromból 2 eszközt érzékelt a dev485 tömbben, valamint csak 1, az USB portra közvetlenül csatlakozó (legelső) elemnek küldte ki a jeleket, a többi egyszerűen ,,elnyelődött''.
	\begin{figure}[h!]
		\centering
		\includegraphics[scale=0.4]{images/foto_sorbakotes.jpg}
		\caption{Két eszköz csatlakoztatásának módja.}
		\subcaption{Forrás: saját kézi rajzom.}
