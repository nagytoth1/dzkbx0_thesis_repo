...
{
    public static class JSONSourceHandler
    {
        private static List<Device> devices = FormHelper.Devices;
        ...
        private static ushort loadedTurns;
        public static ushort LoadedTurns { get => loadedTurns; set => loadedTurns = value; }
        ...
        /// <summary>
        /// Betölt egyetlen eszközlistába
        /// Egyetlen ütem beolvasására használhatjuk. Paraméterben megadhatjuk, hogy konkrétan melyik ütemet szeretnénk betölteni.
        /// Csak annyi ütemet tölthetünk be, amennyit a LoadJSON-eljárás beolvasott.
        /// </summary>
        ...
        public static void LoadTurn(ref ushort turn, List<Device> turnDevices, out ushort turnTime)
        {
            turnTime = 0;
            ...
            System.Console.WriteLine($"{turn}. ütem betöltve");
        }
        ...
        /// </summary>
        /// <param name="path">Beolvasni kívánt JSON-fájl elérési útvonala.</param>        
        public static void LoadJSON(ref string path)
        {
            string fileContent;
            try
            {
            ...
            {
                Logger.WriteLog($"Hiba történt {path} fájlbeolvasás közben...{e.Message}", SeverityLevel.ERROR);
                return;
            }
            ...
            try
            {
                ...
                loadedTurns = (ushort) turnSettings.Length;
                ValidateSettings(turnSettings); //innentől valid JSON van, legalább 1 ütem, minden ütemben stimmel az eszközök típusa
            }
            ...
            MessageBox.Show($"\"{path}\" JSON-fájl sikeresen betöltve!");
        }
        /// <summary>
        ...
        /// </summary>
        /// <param name="turnSettings">Egy ütem eszközökre vonatkozó beállításai.</param>
        /// <exception cref="JsonException"></exception>
        private static void ValidateSettings(SerializedTurnSettings[] turnSettings)
        {
            if (turnSettings == null || turnSettings.Length == 0)
                throw new JsonException("Hibás JSON-forrás: Az ütemek listája üres. Jó a JSON-formátum?");
            ...
            MessageBox.Show($"A forrásfájlt rendben találtam, {turnNumber} ütemet beolvastam.");
        }
    }
}
