...
begin
  { kell ez?
  //ha az SLDLL_ListElem nem futott még le
...
var
  ...
  i : integer;
begin
  //kell ez? - igen, mert lecsekkoljuk, hogy lefutott-e már a SLDLL_Listelem metódus
...
begin
	...
	begin
		...
		//összerendeljük dev485-öt és devList-et egymással azonosítók alapján
